...
import in.mangoo.mangooonlinefooddelivery.Helper.DirectionJSONParser;
import in.mangoo.mangooonlinefooddelivery.Model.Request;
import in.mangoo.mangooonlinefooddelivery.Model.ShippingInformation;
        ...
        requests.child(Common.currentKey)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            mService.getLocationFromAddress(new StringBuilder("http://maps.googleapis.com/maps/api/geocode/json?address=")
                        ...
                        {
                            mService.getLocationFromAddress(new StringBuilder("http://maps.googleapis.com/maps/api/geocode/json?latlng=")
